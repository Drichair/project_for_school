...
urlpatterns = [
    ...
    path('voting/<int:voting_id>/edit/', views.voting_edit_page, name='voting_edit'),
    ...
    path('voting/<int:voting_id>/variants/create/', views.new_variant_form_ajax, name='variant_new_form'),
